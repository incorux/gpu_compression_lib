...
template < typename T , char CWARP_SIZE > __host__ void run_afl_decompress_cpu ( int bit_length , T *data            , T *compressed_data   , unsigned long length);
template < typename T , char CWARP_SIZE > __host__ void run_afl_compress_cpu   ( int bit_length , T *compressed_data , T *decompressed_data , unsigned long length);
...
template < typename T , char CWARP_SIZE > __host__ void run_afl_decompress_value_gpu          ( int bit_length, T *compressed_data, T *data, unsigned long length);
...
template < typename T , char CWARP_SIZE > __global__ void afl_decompress_value_gpu            ( int bit_length, T *compressed_data, T *decompress_data, unsigned long length);
...
template < typename T, char CWARP_SIZE > __device__ __host__ T afl_decompress_base_value_gpu ( int bit_length, T *compressed_data, unsigned long pos);
