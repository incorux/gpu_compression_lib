...
template <typename T, char CWARP_SIZE>
__device__  void delta_pafl_compress_base_gpu3 (
        const unsigned int bit_length, 
        unsigned long data_id, 
        unsigned long comp_data_id,
        T *data, T *compressed_data,
...
template < typename T, char CWARP_SIZE >
__global__ void delta_pafl_compress_gpu3 (
        const unsigned int bit_length, 
        T *data, 
        T *compressed_data, 
        T* compressed_data_block_start,
        ...
        )
{
    ...
    delta_pafl_compress_base_gpu3 <T, CWARP_SIZE> (
        ...
        )
{
    ...
    delta_pafl_compress_gpu3 <T, CWARP_SIZE> <<<block_number, block_size>>> (
            bit_length, 
            data, 
            compressed_data, 
        ...
        )
{
    ...
    afl_decompress_gpu <T, CWARP_SIZE> <<<block_number, block_size>>> (
            bit_length, 
            compressed_data, 
            data, 
            length
        ...
        )
{
    ...
    delta_pafl_decompress_gpu <T, CWARP_SIZE> <<<block_number, block_size>>> (
            bit_length, 
            compressed_data, 
            compressed_data_block_start,
            data, 
...
#define GFL_SPEC(X, A) \
template __host__ void run_pafl_compress_gpu_alternate <X,A> ( unsigned int, X *, X *, unsigned long, X *, unsigned long *, unsigned long *);\
template __host__ void run_pafl_decompress_gpu <X,A> (unsigned int, X *, X *, unsigned long , X *, unsigned long *, unsigned long *);\
template __host__ void run_delta_pafl_compress_gpu_alternate <X,A> ( unsigned int bit_length, X *data, X *compressed_data, X* compressed_data_block_start, unsigned long length, X *global_data_patch_values, unsigned long *global_data_patch_index, unsigned long *global_data_patch_count);\
template __host__ void run_delta_pafl_decompress_gpu <X,A> ( unsigned int bit_length, X *compressed_data, X* compressed_data_block_start, X *data, unsigned long length, X *global_data_patch_values, unsigned long *global_data_patch_index, unsigned long *global_data_patch_count);
