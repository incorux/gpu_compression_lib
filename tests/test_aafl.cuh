...
class test_aafl: public test_afl<T, CWARP_SIZE> 
{
    public: 
        virtual void allocateMemory() {
            ...
            mmCudaMalloc(this->manager, (void **) &this->dev_data_bit_lenght, compression_blocks_count);
            mmCudaMalloc(this->manager, (void **) &this->dev_data_position_id, compression_blocks_count);
        }
        ...
        virtual void setup(int max_size) {
            ...
            this->compression_blocks_count = max_size / CWARP_SIZE;
        ...
        virtual void cleanBeforeCompress() {
            cudaMemset(this->dev_data, 0, this->data_size); 
